...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#"><i class="bi bi-wallet2"></i> Opérateur Mobile
            Money</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link <?= url_is('operator/dashboard') ? 'active' : '' ?>"
                                href="<?= site_url('operator/dashboard') ?>">
                                <i class="bi bi-house-door"></i> Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= url_is('operator/prefixes*') ? 'active' : '' ?>"
                                href="<?= site_url('operator/prefixes') ?>">
                                <i class="bi bi-hash"></i> Préfixes Téléphoniques
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= url_is('operator/operation-types*') ? 'active' : '' ?>"
                                href="<?= site_url('operator/operation-types') ?>">
                                <i class="bi bi-gear"></i> Types d'opérations
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= url_is('operator/fees*') ? 'active' : '' ?>"
                                href="<?= site_url('operator/fees') ?>">
                                <i class="bi bi-currency-exchange"></i> Barèmes de frais
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= url_is('operator/clients*') ? 'active' : '' ?>"
                                href="<?= site_url('operator/clients') ?>">
                                <i class="bi bi-people"></i> Comptes Clients
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= url_is('operator/commissions*') ? 'active' : '' ?>"
                                href="<?= site_url('operator/commissions') ?>">
